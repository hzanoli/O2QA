...
from plot import discover_histograms, plot_1d, plot_profile, get_histogram, save
...
def compare():
    parser = argparse.ArgumentParser(description='Compare the results of two files')
